var jsPsychResponsibility = (function (jspsych) {
  ...
  class ResponsibilityPlugin {
      ...
      trial(display_element, trial) {
          ...
          // Set question text based on outcome
          let responsibility_question = "";
          if (trial.outcome === "Passed") {
              responsibility_question = "How responsible are these club members for the proposal passing?";
          } else if (trial.outcome === "Failed to pass") {
              responsibility_question = "How responsible are these club members for the proposal not passing?";
          }
